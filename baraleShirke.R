...
baraleshirke.test <- function(X1,X2,
  ...
  if(!is.character(depth)) 
    stop("depth must be one of the following characters: 'halfspace', 'L2', 'Mahalanobis', 'projection', 'potential', 'qhpeeling', 'simplicial', 'spatial' and 'zonoid'.")
  if(!(depth %in% c('halfspace', 'L2', 'Mahalanobis', 'projection', 'potential', 'qhpeeling', 'simplicial', 'spatial', 'zonoid'))) 
    stop("depth must be one of the following characters: 'halfspace', 'L2', 'Mahalanobis', 'projection', 'potential', 'qhpeeling', 'simplicial', 'spatial' and 'zonoid'.")
